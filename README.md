...
<div style="width: 540px; margin-top: 10px;"> 
    <div align="left" style="line-height: 1.4em;">
        ...
        <span style="font-size: 14px; color: black; font-family: 'Avenir Next LT Pro', sans-serif; display: block; margin-left: 127px;"> Forests, Support Vector Machines), Natural Language Processing</span>
        <span style="font-size: 13px; color: black; font-family: 'Avenir Next LT Pro',margin-left: 148px; sans-serif;">(NLP), Deep Learning and Neural Networks with PyTorch.</span>
    </div>
</div>
