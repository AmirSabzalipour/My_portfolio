...
<span style="font-size: 14px; color: #6baed6; font-family: 'Avenir Next LT Pro'">Programming:</span>
<span style="font-size: 13px; color: dimgray; font-family: 'Avenir Next LT Pro', sans-serif; margin-bottom: -5px;">Python, C, Mathematica, and SQL (Structured Query Language).</span> 
<hr style="border: none; border-top: -5px dashed lightgray; margin: 0; padding: 0;">
<span style="font-size: 14px; color: #6baed6; font-family: 'Avenir Next LT Pro', sans-serif; margin-top: -5px;">Data Science:</span><br>
