...
<div style="width: 540px; margin-top: 10px;"> 
    <div align="left" style="line-height: 1.4em;">
        ...
        <span style="font-size: 13px; color: dimgray; font-family: 'Avenir Next LT Pro', sans-serif; padding-left: 10px;"> Extensive experience in data science libraries such as NumPy, Pandas, Matplotlib, Spark, Seaborn, Cufflinks, and more.</span>
    </div>
</div>
