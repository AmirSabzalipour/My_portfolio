...
<div style="border-radius: 20px; background-color: #f7f7f7; width: 540px; padding: 10px; border: 1px solid #CCCCCC;">
    ...
    <span style="font-size: 15px; color: black; font-family: 'Avenir Next LT Pro', sans-serif;">Programming:</span><span style="font-size: 13.5px; color: black; font-family: 'Avenir Next LT Pro', sans-serif;"></span>
